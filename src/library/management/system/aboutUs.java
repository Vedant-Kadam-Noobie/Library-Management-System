...
public class aboutUs extends JFrame{
	...
	private JPanel contentPane;
        ...
        public aboutUs() {
            ...
            JLabel l6 = new JLabel("Developed By : Vedant.K");
            l6.setFont(new Font("Trebuchet MS", Font.BOLD, 25));
            l6.setBounds(70, 198, 600, 35);
            contentPane.add(l6);

            JLabel l7 = new JLabel("Contact Us : risingved.rv@gmail.com");
            l7.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
            l7.setBounds(70, 260, 600, 34);
            contentPane.add(l7);

            JLabel l8 = new JLabel("palsatyam877@gmail.com");
            l8.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
            l8.setBounds(190, 290, 600, 34);
            contentPane.add(l8);

            JLabel l9 = new JLabel("jaiswalaryan1093@gmail.com");
